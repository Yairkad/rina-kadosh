...
export default function WhatsAppButton() {
  ...
  return (
    <div className="fixed bottom-20 end-4 md:bottom-6 md:end-6 z-50 flex items-center gap-2">
      {/* Tooltip bubble */}
      <AnimatePresence>
        {hovered && (
          <motion.div
            ...
            className="relative bg-white text-stone-800 text-sm font-medium px-4 py-2 rounded-2xl shadow-lg border border-stone-100 whitespace-nowrap"
          >
            דברו איתי 💬
            {/* Arrow pointing right */}
            <span className="absolute top-1/2 -translate-y-1/2 -end-2 w-0 h-0"
              style={{ borderTop: "6px solid transparent", borderBottom: "6px solid transparent", borderInlineStart: "8px solid white" }} />
          </motion.div>
        )}
      </AnimatePresence>
      ...
      <motion.a
        ...
        className="w-14 h-14 rounded-full bg-[#25D366] shadow-lg flex items-center justify-center text-white"
