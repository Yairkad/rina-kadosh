            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-stone-50">
                {products.map((product) => {
                  ...
                  const eventType = (product as unknown as { event_types: { name_he: string } | null }).event_types;
                  const designStyle = (product as unknown as { design_styles: { name_he: string } | null }).design_styles;
